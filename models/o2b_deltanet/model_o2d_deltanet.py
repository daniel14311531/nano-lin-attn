...
from .layer_o2b_deltanet import O2DDeltaNetLayer
...
class Block(nn.Module):
	...
	def __init__(self, config: O2DDeltaNetConfig):
		...
		self.attn = O2DDeltaNetLayer(config)
...
class O2DDeltaNetLM(CausalLM):
	...
	def from_pretrained(cls, ckpt_path):
		...
		model_config = O2DDeltaNetConfig(**checkpoint['model_args'])
