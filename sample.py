...
# -----------------------------------------------------------------------------
# Sampling parameters (can be overridden by configurator.py)
...
if io_config.init_from == 'scratch':
    raise ValueError("init_from='scratch' is not supported for sampling. Use 'resume' instead.")
    ...
    model_args = dict(n_layer=model_config_instance.n_layer, n_head=model_config_instance.n_head, n_embd=model_config_instance.n_embd, block_size=model_config_instance.block_size,
                      bias=model_config_instance.bias, vocab_size=None, dropout=model_config_instance.dropout)
...
load_meta = False
if io_config.init_from == 'resume' and 'config' in checkpoint and 'dataset' in checkpoint['config']: # older checkpoints might not have these...
